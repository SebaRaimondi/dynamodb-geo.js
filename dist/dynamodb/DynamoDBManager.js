...
var DynamoDBManager = /** @class */ (function () {
     ...
     */
    DynamoDBManager.prototype.queryGeohash = function (queryInput, hashKey, range, options) {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, this.config.dynamoDBClient
                                                    .query(__assign(__assign(__assign({}, defaults), queryInput), options))
                                                    .promise()];
                                        case 1:
                                            queryOutput = _a.sent();
