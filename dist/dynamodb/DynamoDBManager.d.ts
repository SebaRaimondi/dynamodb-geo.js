...
import { BatchWritePointOutput, DeletePointInput, DeletePointOutput, GetPointInput, GetPointOutput, PutPointInput, PutPointOutput, UpdatePointInput, UpdatePointOutput, ExtraQuery } from "../types";
...
export declare class DynamoDBManager {
     ...
     */
    queryGeohash(queryInput: DynamoDB.QueryInput | undefined, hashKey: Long, range: GeohashRange, options: ExtraQuery): Promise<DynamoDB.QueryOutput[]>;
