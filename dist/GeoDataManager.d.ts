...
import { BatchWritePointOutput, DeletePointInput, DeletePointOutput, GeoQueryInput, GetPointInput, GetPointOutput, PutPointInput, PutPointOutput, QueryRadiusInput, QueryRectangleInput, UpdatePointInput, UpdatePointOutput, ExtraQuery } from "./types";
...
export declare class GeoDataManager {
     ...
     */
    queryRectangle(queryRectangleInput: QueryRectangleInput, options?: ExtraQuery): Promise<DynamoDB.ItemList>;
    /**
     * <p>
     ...
     * */
    queryRadius(queryRadiusInput: QueryRadiusInput, options?: ExtraQuery): Promise<DynamoDB.ItemList>;
    /**
     * <p>
     ...
     */
    dispatchQueries(covering: Covering, geoQueryInput: GeoQueryInput, options?: ExtraQuery): Promise<any[]>;
    /**
