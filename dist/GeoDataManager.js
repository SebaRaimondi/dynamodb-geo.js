...
var GeoDataManager = /** @class */ (function () {
     ...
     */
    GeoDataManager.prototype.queryRectangle = function (queryRectangleInput, options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.dispatchQueries(covering, queryRectangleInput, options)];
                    case 1:
                        results = _a.sent();
     ...
     * */
    GeoDataManager.prototype.queryRadius = function (queryRadiusInput, options) {
        return __awaiter(this, void 0, void 0, function () {
            var latLngRect, covering, results;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        covering = new Covering_1.Covering(new this.config.S2RegionCoverer().getCoveringCells(latLngRect));
                        return [4 /*yield*/, this.dispatchQueries(covering, queryRadiusInput, options)];
                    case 1:
                        results = _a.sent();
     ...
     */
    GeoDataManager.prototype.dispatchQueries = function (covering, geoQueryInput, options) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        promises = covering.getGeoHashRanges(this.config.hashKeyLength).map(function (range) {
                            ...
                            return _this.dynamoDBManager.queryGeohash(geoQueryInput.QueryInput, hashKey, range, options);
                        });
                        return [4 /*yield*/, Promise.all(promises)];
                    case 1:
                        results = _a.sent();
                        mergedResults = [];
                        results.forEach(function (queryOutputs) {
                            return queryOutputs.forEach(function (queryOutput) {
                                return mergedResults.push.apply(mergedResults, queryOutput.Items);
                            });
                        });
